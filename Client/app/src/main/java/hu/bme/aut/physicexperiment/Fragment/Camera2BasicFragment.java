...
public class Camera2BasicFragment extends Fragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), listener));
        }
    ...
    private static File getOutputMediaFile() {
        ...
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), "PhysicExperiment");
        ...
        mediaFile = new File(mediaStorageDir.getPath() + File.separator +
                "IMG_" + timeStamp + ".jpg");
        Log.d(TAG, "A kép tároló fájl elkészült.");
        return mediaFile;
    }
    ...
    public void setListener(OnImageTakenListener listener) {
    ...
    private static class ImageSaver implements Runnable {
        ...
        ImageSaver(Image image, OnImageTakenListener listener) {
            mImage = image;
            mlistener = listener;
        }
